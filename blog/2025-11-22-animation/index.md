...
이를 해결하기 위해, 웹에서 CSS로 애니메이션을 구현하는 방법을 생각해보았는데요, 그러면 앱 런치 화면에서는 사용할 수가 없는 문제가 있었습니다.
따라서 lottie 라는 도구를 이용해서 애니메이션을 구성한 뒤, json 파일로 출력하여 라이브러리로 렌더링하는 방식을 적용해보려합니다.
[제작 도구 링크](https://lottiefiles.com/kr/lottie-creator)  

다음과 같이 애니메이션을 만들었습니다.
![제작 화면](./gif2.gif)
